...
describe('UpdateStatusPage component; API connection error', () => {
    ...
    describe('UpdateStatusPage.prototype.submitForm', () => {
        ...
        it('should call onStatusUpdateError', async () => {

            expect.assertions(1);

            const spy = jest.spyOn(updateStatusPage, 'onStatusUpdateError');
